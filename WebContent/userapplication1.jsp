    ...
    <div class="bs-docs-example centent">
            ...
            <fieldset>
             ...
             <tr>
                ...
                <td bgcolor="#FFFFFF"><a href="${pageContext.request.contextPath}/showTb.do?status=<s:property value="#tbInfo.statuss"/>&id=<s:property value="#tbInfo.id"/>"><s:property value="#tbInfo.pname"/></a></td>
                ...
                <s:form action="uploads.do" theme="simple" namespace="/" method="post" enctype="multipart/form-data">
