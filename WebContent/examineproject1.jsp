...
<div class="right">
        <div class="bs-docs-example centent">
            <form class="form-horizontal" action="${pageContext.request.contextPath}/setstatus.do?status=tostatus2" method="post"  >
                <fieldset>
                    <div id="legend" class="">
                    ...
                    <div class="control-group">
                        <!-- Text input-->
                        <input type="hidden" value="<s:property value="#request.tbInfo.id"/>" name="id" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<s:property value="#request.tbInfo.linknum"/>" name="linknum" placeholder="必填*" class="input-xlarge">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <label class="radio inline">
                                <input type="radio" value="<s:property value="#request.tbInfo.trainees"/>" name="trainees" value="1" checked="checked">
                                社会人员
                            </label>
                            <label class="radio inline">
                                <input type="radio" value="<s:property value="#request.tbInfo.trainees"/>" name="trainees" value="2" >
                                本校在校生
                            </label>
                            </s:if>
                            ...
                            <label class="radio inline">
                                <input type="radio" value="<s:property value="#request.tbInfo.trainees"/>" name="trainees" value="1" >
                                社会人员
                            </label>
                            <label class="radio inline">
                                <input type="radio" value="<s:property value="#request.tbInfo.trainees"/>" name="trainees" value="2" checked="checked">
                                本校在校生
                            </label>
                            </s:if>
                        </div>
                ...
                <div class="control-group">
                    <!-- Button -->
                    <div class="controls">
                        <button name="button" value="1" class="btn btn-success">通过</button>
                        <button name="button" value="2" class="btn btn-danger">退回</button>
                    </div>
                </div>
            </fieldset>
        </form>
